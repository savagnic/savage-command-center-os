# SAVAGE COMMAND CENTER — ANDROID OS REPLACEMENT GUIDE

This guide explains how to fully replace your Android shell with the Savage Agentic Command Center, turning your device into an autonomous agent node.
...
1. Open Edge Beta and navigate to the deployed Savage Command Center URL.
...
The Command Center web interface is designed to communicate with a local Termux daemon running on your device via WebSockets.
...
1. Open the Savage Command Center from your home screen.
